<?php
    ...
    $stmt = $koneksi->prepare('SELECT * FROM pdfs');
    $stmt->execute();
?>
            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  ...
                  <h6 class="mb-0">Data Dokumen PDF Tersimpan</h6>
                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-air-primary" id="pdf_name" placeholder="Calculus" type="text">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="author" >Author</label>
                                    <input class="form-control input-air-primary" id="author" placeholder="Dr Antont" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input-air-primary" id="desc" placeholder="Calculus" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
